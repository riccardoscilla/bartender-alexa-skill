...
* form: deny: no one   <!-- predicted: cardinal: no one -->
    ...
    - slot{"ingr_list": ""}
    - action_listen   <!-- predicted: action_preparation -->
...
* search_provider: [vodka](ingredient) and [gin](ingredient) [cocktail](category)   <!-- predicted: search_provider: vodka and [gin](ingredient) [cocktail](category) -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
...
* explain: explain [yolk](cocktail)   <!-- predicted: explain: explain [yolk](ingredient) -->
    ...
    - slot{"cocktail": null}
    - action_listen   <!-- predicted: utter_ask_explanation -->
...
* affirm: yes
    - search_form
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [gin](ingredient)   <!-- predicted: greet: gin -->
    - form: search_form
    - slot{"ingredient": ["gin"]}
    - slot{"multiple_options": false}
    - slot{"category": "cocktail"}
...
* affirm: yes
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* search_provider: [cocktail](category) with [ginger ale](ingredient)   <!-- predicted: search_provider: [cocktail](category) with [ginger](ingredient) [ale](cocktail) -->
    - slot{"cocktail": "ale"}
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
...
* form: search_provider: [lime](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* thanks: that's all   <!-- predicted: deny: that'[s](cocktail) all -->
    - slot{"cocktail": "s"}
...
* ask_ingredients: no more ingredients
    ...
    - slot{"ingr_list": "tequila,lime"}
    - utter_ask_continue   <!-- predicted: action_search -->
    - action_listen
* form: affirm: yes
    - search_form
    - slot{"requested_slot": "ingredient"}
* deny: no more
    ...
    - slot{"ingr_list": "tequila,lime"}
    - action_listen   <!-- predicted: utter_ask_something_else -->
* affirm: yes
    - action_search
    - slot{"category": null}
    - slot{"ingr_list": ""}
    ...
    - slot{"requested_slot": null}
    - action_reset_all_slots
    - utter_ask_something_else   <!-- predicted: utter_goodbye -->
* goodbye: no more bye
    - action_deactivate_form
    - form{"name": null}
    - slot{"requested_slot": null}
...
* affirm: yes please
    - action_explain   <!-- predicted: action_deactivate_form -->
    - slot{"cocktail": "mary pickford"}
* explain: could you explain [horse's neck](cocktail)   <!-- predicted: explain: could you explain horse'[s neck](cocktail) -->
    - slot{"cocktail": "s neck"}
    - slot{"cocktail": "horse's neck"}
    - action_explain
    - slot{"cocktail": "horse's neck"}
...
* explain: what is [golden dream](cocktail)
    ...
    - action_explain
    - slot{"cocktail": "golden dream"}
* ask_preparation: thank you, prepare [horse's neck](cocktail)   <!-- predicted: ask_preparation: thank you, prepare horse'[s neck](cocktail) -->
    - slot{"cocktail": "s neck"}
    - slot{"cocktail": "horse's neck"}
    - action_preparation
    - slot{"cocktail": "horse's neck"}
...
* affirm: yes please
    ...
    - slot{"more_results": false}
    - slot{"cocktail": null}
    - choice_form   <!-- predicted: utter_ask_explanation -->
    - form{"name": "choice_form"}
    - slot{"requested_slot": "cardinal"}
* form: cardinal: the [2](cardinal) one   <!-- predicted: cardinal: the [2](cocktail) one -->
    - slot{"cocktail": "2"}
...
* search_provider: i want a [cocktail](category) with [lemon juice](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cognac](ingredient)   <!-- predicted: affirm: cognac -->
    - form: search_form
...
* affirm: yes please
    ...
    - slot{"cocktail": "vesper"}
    - utter_ask_explanation
* explain: show me [some information](cocktail)   <!-- predicted: ask_ingredients: show me some [information](cocktail) -->
    - slot{"cocktail": "information"}
    - slot{"cocktail": "some information"}
    - action_explain
    - slot{"cocktail": null}
* affirm: yes
    - action_explain   <!-- predicted: action_repeat -->
    - slot{"cocktail": null}
...
* form: search_provider: [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [wiskey](ingredient)   <!-- predicted: explain: wiskey -->
    - form: search_form
    - slot{"ingredient": null}
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
