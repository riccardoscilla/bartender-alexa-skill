...
* search_provider: i have [vodka](ingredient)   <!-- predicted: search_provider: i have vodka -->
    - search_form
...
* search_provider: i want a [cocktail](category) with [juice](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [Tomato juice](ingredient)   <!-- predicted: search_provider: Tomato [juice](ingredient) -->
    - form: search_form
...
* search_provider: show [some](cocktail) info [about[bloody mary](cocktail) bloody mary   <!-- predicted: explain: show some info [about[bloody](cocktail) [mary](cocktail) [bloody mary](cocktail) -->
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
    - search_form   <!-- predicted: action_explain -->
    - form{"name": "search_form"}
    - slot{"requested_slot": "category"}
* form: deny: no one   <!-- predicted: cardinal: no one -->
    - form: action_deactivate_form   <!-- predicted: search_form -->
    - form{"name": null}
    - slot{"requested_slot": null}
    - action_ask_confirm   <!-- predicted: action_reset_all_slots -->
    - slot{"ingr_list": ""}
* search_provider: tell me something [about](cocktail) [bloody mary](cocktail)   <!-- predicted: search_provider: [tell](cocktail) me something [about](cocktail) [bloody mary](cocktail) -->
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
    - search_form
    - form{"name": "search_form"}
...
* search_provider: i have [milk](ingredient) and [ginger](ingredient)
    ...
    - slot{"multiple_options": true}
    - slot{"requested_slot": "category"}
* form: search_provider: [ginger ale](ingredient)   <!-- predicted: explain: [ginger](ingredient) ale -->
    - form: search_form
...
* explain: explain [horse's neck](cocktail)   <!-- predicted: explain: explain horse'[s](cocktail) neck -->
    - slot{"cocktail": "s"}
    - slot{"cocktail": "horse's neck"}
    - action_explain
    - slot{"cocktail": "horse's neck"}
...
* search_provider: i a want a [coffee](ingredient) [cocktail](category)   <!-- predicted: search_provider: i a want a [coffee cocktail](ingredient) -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
...
* search_provider: [vodka](ingredient) and [gin](ingredient) [cocktail](category)   <!-- predicted: search_provider: vodka and gin [cocktail](category) -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
...
* form: search_provider: [khlua](ingredient)
    ...
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [kalhua](ingredient)   <!-- predicted: thanks: kalhua -->
    - form: search_form
    - slot{"ingredient": null}
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
* affirm: [bayleis](cocktail)   <!-- predicted: explain: [bayleis](cocktail) -->
...
## Story 17 (tests/conversation_tests.md)
* ask_preparation: prepare [spritz](cocktail)
    - slot{"cocktail": "spritz"}
    - slot{"cocktail": "spritz"}
    - action_preparation
    - slot{"cocktail": "spritz"}
* explain: what is inside [tequila sunrise](cocktail)   <!-- predicted: explain: what is [inside](cocktail) [tequila sunrise](cocktail) -->
    - slot{"cocktail": "tequila sunrise"}
    - slot{"cocktail": "tequila sunrise"}
    - action_explain
    - slot{"cocktail": "tequila sunrise"}
...
* search_provider: i want  a [punch](category)
    ...
    - slot{"category": "punch"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [olive](ingredient)   <!-- predicted: cardinal: [olive](cardinal) -->
    - slot{"cardinal": "olive"}
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
...
* form: search_provider: [olive](ingredient)   <!-- predicted: cardinal: [olive](cardinal) -->
    ...
    - slot{"category": "punch"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [brandy](ingredient)   <!-- predicted: thanks: [brandy](ingredient) -->
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
    - slot{"category": "punch"}
...
* form: search_provider: [sugar syrum](ingredient) and [campari](ingredient)
    ...
    - slot{"category": "punch"}
    - slot{"requested_slot": "ingredient"}
* form: ask_ingredients: what ingredients did i choose
...
* affirm: yes
    - search_form
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [gin](ingredient)   <!-- predicted: affirm: gin -->
    - form: search_form
    - slot{"ingredient": ["gin"]}
    - slot{"multiple_options": false}
    - slot{"category": "cocktail"}
...
* affirm: yes
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* search_provider: [cocktail](category) with [ginger ale](ingredient)   <!-- predicted: search_provider: [cocktail](category) with [ginger](ingredient) ale -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
    - slot{"ingredient": ["ginger ale"]}
...
* search_provider: [drink](category)   <!-- predicted: search_provider: drink -->
    ...
    - slot{"category": null}
    - slot{"requested_slot": "category"}
* form: search_provider: [cocktail](category) with [gin](ingredient)   <!-- predicted: search_provider: [cocktail](category) with gin -->
    - form: search_form
    - slot{"ingredient": ["gin"]}
    - slot{"category": "cocktail"}
    - slot{"multiple_options": false}
...
* form: search_provider: [sugar](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cointreau](ingredient)   <!-- predicted: affirm: [cointreau](ingredient) -->
    - form: search_form
...
* form: search_provider: [brandy](ingredient)   <!-- predicted: thanks: [brandy](ingredient) -->
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [vodka](ingredient)   <!-- predicted: affirm: vodka -->
    - form: search_form
    - slot{"ingredient": ["vodka"]}
    - slot{"multiple_options": false}
    - slot{"category": "cocktail"}
...
* affirm: yes
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* search_provider: [cocktail](category) with [timato juice](ingredient)   <!-- predicted: search_provider: [cocktail](category) with timato [juice](ingredient) -->
    - search_form
    - form{"name": "search_form"}
    - action_listen
    - slot{"category": "cocktail"}
...
* ask_preparation: preapre [grasshopper](cocktail)
    ...
    - action_preparation
    - slot{"cocktail": "grasshopper"}
* search_provider: [cocktail](category) with [egg white](ingredient)   <!-- predicted: search_provider: [cocktail](category) with [egg](ingredient) [white](cocktail) -->
    - slot{"cocktail": "white"}
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
...
* form: search_provider: [grenadine](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [maraschino liqueur](ingredient)   <!-- predicted: explain: [maraschino liqueur](cocktail) -->
...
* affirm: yes please
    - action_explain
    - slot{"cocktail": "mary pickford"}
* explain: could you explain [horse's neck](cocktail)   <!-- predicted: explain: could you explain horse'[s](cocktail) neck -->
    - slot{"cocktail": "s"}
    - slot{"cocktail": "horse's neck"}
    - action_explain
    - slot{"cocktail": "horse's neck"}
...
* explain: what is [golden dream](cocktail)
    ...
    - action_explain
    - slot{"cocktail": "golden dream"}
* ask_preparation: thank you, prepare [horse's neck](cocktail)   <!-- predicted: ask_preparation: thank you, prepare horse'[s](cocktail) neck -->
    - slot{"cocktail": "s"}
    - slot{"cocktail": "horse's neck"}
    - action_preparation
    - slot{"cocktail": "horse's neck"}
...
* search_provider: i want a [cocktail](category)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [coffee](ingredient) and [irish whiskey](ingredient)   <!-- predicted: explain: [coffee](cocktail) and [irish](cocktail) [whiskey](cocktail) -->
    - slot{"cocktail": "whiskey"}
    - form: search_form
...
* search_provider: i want a [cocktail](category)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [vermouth](ingredient) and [olive](ingredient)   <!-- predicted: search_provider: [vermouth](ingredient) and [olive](cardinal) -->
    - slot{"cardinal": "olive"}
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [dry vermouth](ingredient) and [olive](ingredient)   <!-- predicted: search_provider: [dry vermouth](cocktail) and [olive](cardinal) -->
    - slot{"cardinal": "olive"}
    - slot{"cocktail": "dry vermouth"}
    - form: search_form
...
* form: search_provider: a [cocktail](category)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [creme de cassis](ingredient) and [vodka](ingredient)   <!-- predicted: search_provider: [creme de cassis](ingredient) and vodka -->
    - form: search_form
...
* search_provider: i want a [cocktail](category) with [lemon juice](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cognac](ingredient)   <!-- predicted: affirm: [cognac](ingredient) -->
    - form: search_form
...
* form: search_provider: a [cocktail](category) with [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cherry](ingredient) please   <!-- predicted: affirm: cherry please -->
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
    - slot{"category": "cocktail"}
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cherry](ingredient)   <!-- predicted: affirm: cherry -->
    - form: search_form
...
* greet: good evening bot
    ...
    - action_reset_all_slots
    - utter_how_can_i_help
* explain: how can i [make](cocktail) [golden dream](cocktail)   <!-- predicted: ask_preparation: how can i [make](cocktail) [golden dream](cocktail) -->
    - slot{"cocktail": "golden dream"}
    - slot{"cocktail": "golden dream"}
...
* search_provider: i want to drink
    ...
    - form{"name": "search_form"}
    - slot{"requested_slot": "category"}
* form: search_provider: a [cocktail](category) with [vodka](ingredient)   <!-- predicted: search_provider: a [cocktail](category) with vodka -->
    - form: search_form
    - slot{"ingredient": ["vodka"]}
    - slot{"category": "cocktail"}
    - slot{"multiple_options": false}
...
* search_provider: i want a drink
    ...
    - form{"name": "search_form"}
    - slot{"requested_slot": "category"}
* form: search_provider: a [cocktail](category) with vo[vodka](ingr[gin](ingredient)ent)nd gin   <!-- predicted: search_provider: a [cocktail](category) with vovodkaent)nd gin -->
    - form: search_form
    - slot{"ingredient": ["vodka", "gin"]}
    - slot{"category": "cocktail"}
    - slot{"multiple_options": false}
...
* affirm: yes please
    ...
    - slot{"cocktail": "vesper"}
    - utter_ask_explanation
* explain: show me [some information](cocktail)   <!-- predicted: ask_functions: show me some [information](cocktail) -->
...
* ask_preparation: can you prepare [stinger](cocktail)
    ...
    - action_preparation
    - slot{"cocktail": "stinger"}
* thanks: thank you sir   <!-- predicted: thanks: thank you [sir](cocktail) -->
    - slot{"cocktail": "sir"}
    - action_deactivate_form
    - form{"name": null}
    - slot{"requested_slot": null}
...
* search_provider: [give](ingredient) me a [cocktail](category)   <!-- predicted: search_provider: [give](cardinal) me a [cocktail](category) -->
    - slot{"cardinal": "give"}
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
    ...
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [pineapple juice](ingredient) and [maraschino cherry](ingredient)   <!-- predicted: search_provider: [pineapple juice](ingredient) and [maraschino](cocktail) [cherry](ingredient) -->
...
* affirm: ok
    ...
    - slot{"more_results": false}
    - slot{"cocktail": "mary pickford"}
    - utter_ask_explanation   <!-- predicted: choice_form -->
    - action_listen   <!-- predicted: choice_form -->
* affirm: sure
    - action_search   <!-- predicted: choice_form -->
    - slot{"category": "cocktail"}
    - slot{"ingr_list": "pineapple juice,maraschino cherry"}
    - slot{"proposes": null}
    - slot{"more_results": false}
...
* greet: hi
    ...
    - action_reset_all_slots
    - utter_how_can_i_help
* ask_preparation: prepare [gin tonic](cocktail)   <!-- predicted: ask_preparation: prepare gin tonic -->
    - slot{"cocktail": "gin tonic"}
    - action_preparation
    - slot{"cocktail": null}
* search_provider: [cocktail](category) with [gin](ingredient)   <!-- predicted: search_provider: [cocktail](category) with gin -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
    - slot{"ingredient": ["gin"]}
...
* affirm: yes
    ...
    - slot{"more_results": true}
    - slot{"cocktail": null}
* ask_preparation: prepare [gin fizz](cocktail)   <!-- predicted: ask_preparation: prepare gin fizz -->
...
* ask_preparation: could you prepare a [cocktail](category)
    - action_preparation
    - slot{"cocktail": "vesper"}
* search_provider: show [cocktails](category) with [gin](ingredient)   <!-- predicted: search_provider: show [cocktails](category) with gin -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": null}
    - slot{"ingredient": ["gin"]}
    - slot{"multiple_options": false}
    - slot{"requested_slot": "category"}
* form: search_provider: show [cocktail](category) with [gin](ingredient)   <!-- predicted: search_provider: show [cocktail](category) with gin -->
    - form: search_form
    - slot{"ingredient": ["gin"]}
    - slot{"category": "cocktail"}
    - slot{"multiple_options": false}
...
* form: search_provider: [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [wiskey](ingredient)   <!-- predicted: explain: [wiskey](ingredient) -->
    - form: search_form
    - slot{"ingredient": null}
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
