...
* ask_preparation: how can i prepare it
    - action_preparation
    - slot{"cocktail": "harvey wallbanger"}
* thanks: oh nice cardinal thank you   <!-- predicted: affirm: oh nice cardinal thank you -->
    - action_deactivate_form   <!-- predicted: action_default_fallback -->
    - form{"name": null}
    - slot{"requested_slot": null}
    - action_reset_all_slots
...
* ask_ingredients: list ingredients
    ...
    - slot{"ingr_list": "cranberry juice"}
    - utter_ask_continue   <!-- predicted: action_listen -->
    - action_listen
* form: affirm: yes
    - search_form
    - slot{"requested_slot": "ingredient"}
...
* explain: explain [vesper](cocktail)
    ...
    - action_explain
    - slot{"cocktail": "vesper"}
* ask_preparation: could you prepare a [cocktail](category)   <!-- predicted: search_provider: could you prepare a [cocktail](category) -->
    - action_preparation   <!-- predicted: action_default_fallback -->
    - slot{"cocktail": "vesper"}
    - action_listen   <!-- predicted: search_form -->
...
* explain: i want a [mojito](cocktail)   <!-- predicted: explain: i want a mojito -->
    - slot{"cocktail": "mojito"}
    - action_explain   <!-- predicted: action_default_fallback -->
    - slot{"cocktail": "mojito"}
* ask_preparation: how can i prepare it
...
* form: search_provider: [vodka](ingredient)   <!-- predicted: search_provider: vodka -->
    ...
    - form{"name": null}
    - slot{"requested_slot": null}
    - search_form   <!-- predicted: utter_ask_explanation -->
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: deny: no more
    ...
    - form{"name": null}
    - slot{"requested_slot": null}
    - action_ask_confirm   <!-- predicted: utter_ask_explanation -->
    - slot{"ingr_list": "dry vermouth,vodka"}
* affirm: yes please
    - action_search
    - slot{"category": "cocktail"}
