...
* form: cardinal: the [4](cardinal)   <!-- predicted: cardinal: the [4](cocktail) -->
    - slot{"cocktail": "4"}
    - slot{"cardinal": "4"}
    - choice_form
    - slot{"cardinal": 3}
...
* affirm: yes
    ...
    - action_listen
    - slot{"requested_slot": "cardinal"}
* form: cardinal: the [2](cardinal)   <!-- predicted: cardinal: the [2](cocktail) -->
    - slot{"cocktail": "2"}
    - slot{"cardinal": "2"}
    - choice_form
    - slot{"cardinal": 1}
...
* deny: no
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* explain: explain [horse's neck](cocktail)   <!-- predicted: explain: explain [horse's](cocktail) [neck](cocktail) -->
    - slot{"cocktail": "neck"}
    - slot{"cocktail": "horse's neck"}
    - action_explain
    - slot{"cocktail": "horse's neck"}
...
* search_provider: [cocktail](category) with [min](ingr[rum](ingredient)ent) and rum   <!-- predicted: search_provider: [cocktail](category) with [minent](ingredient)[)](ingredient) and [rum](ingredient) -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
    - slot{"ingredient": []}
...
* search_provider: i want  a [punch](category)
    ...
    - slot{"category": "punch"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [olive](ingredient)   <!-- predicted: cardinal: [olive](ingredient) -->
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
    - slot{"category": "punch"}
...
* explain: explain [yolk](cocktail)   <!-- predicted: explain: explain [yolk](ingredient) -->
    ...
    - action_explain
    - slot{"cocktail": null}
* explain: explan [derby](cocktail)   <!-- predicted: explain: [explan](cocktail) [derby](cocktail) -->
    - slot{"cocktail": "derby"}
    - slot{"cocktail": "derby"}
    - action_explain
    - slot{"cocktail": "derby"}
...
* form: cardinal: the [firs](cardinal)   <!-- predicted: cardinal: the [firs](ingredient) -->
    - slot{"cardinal": "firs"}
    - choice_form
* form: explain: [1](cocktail)   <!-- predicted: cardinal: [1](cocktail) -->
    - slot{"cocktail": "1"}
    - slot{"cocktail": "1"}
...
* affirm: i'm ok   <!-- predicted: deny: i'm ok -->
    ...
    - action_listen
* form: search_provider: [cocktail](category) with [tequila](ingr[lime](ingredient)nt) and lime   <!-- predicted: search_provider: [cocktail](category) with [tequilant](ingredient)[)](ingredient) and [lime](ingredient) -->
    - search_form
    - slot{"category": "cocktail"}
...
* form: search_provider: [lime](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: thanks: that's all   <!-- predicted: ask_functions: that['s](cocktail) all -->
    - slot{"cocktail": "'s"}
...
* search_provider: i want a [cocktail](category)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [pineapple huice](ingredient)   <!-- predicted: search_provider: [pineapple](ingredient) huice -->
    - form: search_form
    - slot{"ingredient": null}
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
...
* affirm: yes please
    - action_explain
    - slot{"cocktail": "mary pickford"}
* explain: could you explain [horse's neck](cocktail)   <!-- predicted: explain: could you explain [horse's](cocktail) [neck](cocktail) -->
    - slot{"cocktail": "neck"}
    - slot{"cocktail": "horse's neck"}
    - action_explain
    - slot{"cocktail": "horse's neck"}
...
* search_provider: i want a drink
    ...
    - form{"name": "search_form"}
    - slot{"requested_slot": "category"}
* form: search_provider: a [cocktail](category) with vo[vodka](ingr[gin](ingredient)ent)nd gin   <!-- predicted: search_provider: a [cocktail](category) with vovodkaent[)](ingredient)nd [gin](ingredient) -->
    - form: search_form
    - slot{"ingredient": ["vodka", "gin"]}
    - slot{"category": "cocktail"}
    - slot{"multiple_options": false}
...
* form: search_provider: [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [wiskey](ingredient)   <!-- predicted: greet: wiskey -->
    - form: search_form
    - slot{"ingredient": null}
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
...
* deny: no
    ...
    - action_listen
    - slot{"requested_slot": "cardinal"}
* form: cardinal: the [7](cardinal)   <!-- predicted: cardinal: the [7](cocktail) -->
    - slot{"cocktail": "7"}
    - slot{"cardinal": "7"}
    - choice_form
    - slot{"cardinal": 6}
