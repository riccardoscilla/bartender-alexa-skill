...
* form: cardinal: the [4](cardinal)   <!-- predicted: search_provider: the [4](ingredient) -->
    - slot{"cardinal": "4"}
    - choice_form
    - slot{"cardinal": 3}
    - slot{"category": null}
...
* affirm: yes
    ...
    - action_listen
    - slot{"requested_slot": "cardinal"}
* form: cardinal: the [2](cardinal) one   <!-- predicted: cardinal: the [2](ingredient) one -->
    - slot{"cardinal": "2"}
    - choice_form
    - slot{"cardinal": 1}
    - slot{"category": null}
...
* search_provider: show [some](cocktail) info [about[bloody mary](cocktail) bloody mary   <!-- predicted: explain: show some info about[[bloody mary](cocktail) [bloody mary](cocktail) -->
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
...
* search_provider: tell me something [about](cocktail) [bloody mary](cocktail)   <!-- predicted: search_provider: tell me something about [bloody mary](cocktail) -->
    ...
    - form{"name": "search_form"}
    - slot{"requested_slot": "category"}
* form: explain: [bloody mary](cocktail)   <!-- predicted: search_provider: [bloody mary](cocktail) -->
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
...
* form: thanks: thank you
    ...
    - slot{"requested_slot": null}
    - action_reset_all_slots
    - utter_you_are_welcome_ask_something_else   <!-- predicted: utter_explain_functions -->
* affirm: yes
...
* affirm: yes
    ...
    - action_listen
    - slot{"requested_slot": "cardinal"}
* form: cardinal: the [2](cardinal)   <!-- predicted: search_provider: the [2](ingredient) -->
    - slot{"cardinal": "2"}
    - choice_form
    - slot{"cardinal": 1}
    - slot{"category": null}
...
* search_provider: [cocktail](category) with [min](ingr[rum](ingredient)ent) and rum   <!-- predicted: search_provider: [cocktail](category) with minent) and [rum](ingredient) -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
    - slot{"ingredient": []}
...
* form: cardinal: the [firs](cardinal)   <!-- predicted: cardinal: the [firs](ingredient) -->
    - slot{"cardinal": "firs"}
    - choice_form
* form: explain: [1](cocktail)   <!-- predicted: search_provider: [1](ingredient) -->
    - slot{"cocktail": "1"}
...
* affirm: yes
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* ask_preparation: preapre [tuxedo cocktail](cocktail)   <!-- predicted: search_provider: [preapre](ingredient) [tuxedo cocktail](cocktail) -->
...
* ask_preparation: preapre [grasshopper](cocktail)   <!-- predicted: ask_preparation: [preapre](ingredient) [grasshopper](cocktail) -->
...
* form: search_provider: [lime](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: thanks: that's all   <!-- predicted: cardinal: that['s](cocktail) all -->
    - slot{"cocktail": "'s"}
...
* affirm: yes
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* goodbye: no more bye   <!-- predicted: ask_functions: no more bye -->
    - action_deactivate_form
    - form{"name": null}
    - slot{"requested_slot": null}
    - action_reset_all_slots
...
* form: search_provider: [pineapple juice](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [granadine](ingredient)   <!-- predicted: search_provider: [granadine](cocktail) -->
    - slot{"cocktail": "granadine"}
    - form: search_form
    - slot{"ingredient": null}
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
* form: ask_ingredients: which ingredients do i choose
    - form: action_list_ingredients   <!-- predicted: search_form -->
    - slot{"ingr_list": "pineapple juice"}
    - form: utter_ask_continue   <!-- predicted: search_form -->
    - form: action_listen   <!-- predicted: search_form -->
...
* thanks: thank you
    ...
    - action_reset_all_slots
    - utter_you_are_welcome_ask_something_else
* goodbye: no bye   <!-- predicted: ask_functions: no bye -->
    - action_deactivate_form
    - form{"name": null}
    - slot{"requested_slot": null}
    - action_reset_all_slots
...
* affirm: yes please
    ...
    - slot{"cocktail": "vesper"}
    - utter_ask_explanation
* explain: show me [some information](cocktail)   <!-- predicted: explain: show me some information -->
...
* search_provider: [give](ingredient) me a [cocktail](category)   <!-- predicted: search_provider: give me a [cocktail](category) -->
    ...
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [pineapple juice](ingredient) and [maraschino cherry](ingredient)   <!-- predicted: search_provider: [pineapple juice](ingredient) and [maraschino](ingredient) [cherry](ingredient) -->
    - form: search_form
...
* affirm: ok
    ...
    - slot{"cocktail": "mary pickford"}
    - utter_ask_explanation
* affirm: sure   <!-- predicted: explain: sure -->
    - action_search   <!-- predicted: action_explain -->
    - slot{"category": "cocktail"}
    - slot{"ingr_list": "pineapple juice,maraschino cherry"}
    - slot{"proposes": null}
...
* deny: nothing more
    ...
    - action_ask_confirm
    - slot{"ingr_list": "cranberry juice,grapefruit juice"}
* affirm: yes bot   <!-- predicted: greet: yes bot -->
    - action_search   <!-- predicted: action_deactivate_form -->
    - slot{"category": "cocktail"}
    - slot{"ingr_list": "cranberry juice,grapefruit juice"}
    - slot{"proposes": null}
...
* form: search_provider: [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [wiskey](ingredient)   <!-- predicted: search_provider: [wiskey](cocktail) -->
...
* affirm: yes
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* search_provider: [cocktail](category) [gin](ingredient)   <!-- predicted: search_provider: [cocktail gin](category) -->
    - search_form
    - form{"name": "search_form"}
    - slot{"category": "cocktail"}
    - slot{"ingredient": ["gin"]}
...
* deny: no
    ...
    - action_listen
    - slot{"requested_slot": "cardinal"}
* form: cardinal: the [7](cardinal)   <!-- predicted: search_provider: the [7](ingredient) -->
    - slot{"cardinal": "7"}
    - choice_form
    - slot{"cardinal": 6}
    - slot{"category": null}
