...
* search_provider: show [some](cocktail) info [about[bloody mary](cocktail) bloody mary   <!-- predicted: search_provider: show some info about[[bloody](cocktail) [mary](cocktail) [bloody mary](cocktail) -->
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
    - search_form
    - form{"name": "search_form"}
...
* form: cardinal: the [firs](cardinal)   <!-- predicted: cardinal: the [firs](ingredient) -->
    - slot{"cardinal": "firs"}
    - choice_form
* form: explain: [1](cocktail)   <!-- predicted: search_provider: [1](cocktail) -->
    - slot{"cocktail": "1"}
    - slot{"cocktail": "1"}
...
* search_provider: i want a [cocktail](category)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [coffee](ingredient) and [irish whiskey](ingredient)   <!-- predicted: explain: [coffee](ingredient) and [irish whiskey](cocktail) -->
...
* form: search_provider: a [cocktail](category) with [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cherry](ingredient) please   <!-- predicted: cardinal: [cherry](cocktail) please -->
...
* affirm: yes
    ...
    - slot{"more_results": true}
    - slot{"cocktail": null}
* ask_preparation: prepare [gin fizz](cocktail)   <!-- predicted: ask_preparation: prepare [gin](cocktail) [fizz](cocktail) -->
    - slot{"cocktail": "fizz"}
