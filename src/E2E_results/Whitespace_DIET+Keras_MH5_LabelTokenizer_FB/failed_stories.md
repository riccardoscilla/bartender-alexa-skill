...
* search_provider: show [some](cocktail) info [about[bloody mary](cocktail) bloody mary   <!-- predicted: ask_preparation: show some info [about[bloody](cocktail) [mary](cocktail) [bloody mary](cocktail) -->
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
...
* form: deny: no one   <!-- predicted: cardinal: no one -->
    ...
    - slot{"ingr_list": ""}
* search_provider: tell me something [about](cocktail) [bloody mary](cocktail)   <!-- predicted: search_provider: [tell](cardinal) me something [about](cocktail) [bloody mary](cocktail) -->
    - slot{"cardinal": "tell"}
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
    - search_form
...
* form: search_provider: [kalhua](ingredient)
    ...
    - slot{"multiple_options": false}
    - slot{"requested_slot": "ingredient"}
* form: affirm: [bayleis](cocktail)   <!-- predicted: affirm: bayleis -->
...
* form: search_provider: [olive](ingredient)   <!-- predicted: cardinal: [olive](cardinal) -->
    ...
    - slot{"category": "punch"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [brandy](ingredient)   <!-- predicted: explain: [brandy](ingredient) -->
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
    - slot{"category": "punch"}
...
* form: search_provider: [lime](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: thanks: that's all   <!-- predicted: affirm: that's all -->
...
* search_provider: i want a [cocktail](category)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [coffee](ingredient) and [irish whiskey](ingredient)   <!-- predicted: explain: [coffee](ingredient) and [irish](cocktail) [whiskey](cocktail) -->
...
* search_provider: i want a [cocktail](category) with [sweet and sour](ingredient)   <!-- predicted: search_provider: i want a [cocktail](category) with [sweet](ingredient) and [sour](ingredient) -->
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [triple sec](ingredient) and [cherry](ingredient)   <!-- predicted: search_provider: [triple sec](ingredient) and cherry -->
    - form: search_form
...
* affirm: sure   <!-- predicted: affirm: [sure](ingredient) -->
...
* form: search_provider: [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [wiskey](ingredient)   <!-- predicted: explain: [wiskey](cocktail) -->
