...
* form: deny: no one   <!-- predicted: cardinal: no one -->
    ...
    - slot{"ingr_list": ""}
* search_provider: tell me something [about](cocktail) [bloody mary](cocktail)   <!-- predicted: search_provider: [tell](cocktail) me something [about](ingredient) [bloody mary](cocktail) -->
    - slot{"cocktail": "bloody mary"}
    - slot{"cocktail": "bloody mary"}
    - search_form   <!-- predicted: choice_form -->
    - form{"name": "search_form"}
    - slot{"requested_slot": "category"}
* form: explain: [bloody mary](cocktail)
    ...
    - slot{"cocktail": "bloody mary"}
    - form: action_listen   <!-- predicted: choice_form -->
...
* search_provider: i have [milk](ingredient) and [ginger](ingredient)
    ...
    - slot{"multiple_options": true}
    - slot{"requested_slot": "category"}
* form: search_provider: [ginger ale](ingredient)   <!-- predicted: search_provider: [ginger](ingredient) ale -->
    - form: search_form
...
* deny: no
    ...
    - action_reset_all_slots
    - utter_ask_something_else
* explain: explain [horse's neck](cocktail)   <!-- predicted: explain: explain horse'[s neck](cocktail) -->
    - slot{"cocktail": "s neck"}
    - slot{"cocktail": "horse's neck"}
    - action_explain
    - slot{"cocktail": "horse's neck"}
* ask_preparation: prepare it
...
* form: search_provider: [olive](ingredient)   <!-- predicted: cardinal: [olive](cardinal) -->
    ...
    - slot{"category": "punch"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [brandy](ingredient)   <!-- predicted: goodbye: [brandy](ingredient) -->
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
    - slot{"category": "punch"}
...
* form: deny: no more
    ...
    - form{"name": null}
    - slot{"requested_slot": null}
    - action_ask_confirm   <!-- predicted: action_explain -->
    - slot{"ingr_list": "olive,brandy,campari"}
...
* affirm: yes please
    ...
    - form{"name": null}
    - slot{"requested_slot": null}
    - action_reset_all_slots   <!-- predicted: action_explain -->
    - utter_ask_something_else   <!-- predicted: action_explain -->
...
* affirm: yes
    - search_form
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [gin](ingredient)   <!-- predicted: deny: gin -->
    - form: search_form
    - slot{"ingredient": ["gin"]}
    - slot{"multiple_options": false}
    - slot{"category": "cocktail"}
...
* ask_preparation: prepare [harvey wallbanger](cocktail)
    ...
    - slot{"cocktail": "harvey wallbanger"}
    - action_preparation   <!-- predicted: utter_you_are_welcome_ask_something_else -->
    - slot{"cocktail": "harvey wallbanger"}
* goodbye: bye!
    - action_deactivate_form
    - form{"name": null}
...
* form: search_provider: a [cocktail](category) with [orange bitters](ingredient)
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cherry](ingredient) please   <!-- predicted: cardinal: cherry please -->
    - form: search_form
    - slot{"ingredient": []}
    - slot{"multiple_options": true}
    - slot{"category": "cocktail"}
    ...
    - slot{"category": "cocktail"}
    - slot{"requested_slot": "ingredient"}
* form: search_provider: [cherry](ingredient)   <!-- predicted: greet: cherry -->
    - form: search_form
...
* ask_preparation: can you prepare [stinger](cocktail)
    ...
    - action_preparation
    - slot{"cocktail": "stinger"}
* thanks: thank you sir   <!-- predicted: thanks: thank you [sir](cardinal) -->
    - slot{"cardinal": "sir"}
    - action_deactivate_form
    - form{"name": null}
    - slot{"requested_slot": null}
